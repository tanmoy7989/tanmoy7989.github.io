...
\cvline{}{Integrative modeling of protein complexes, chemical crosslinking, protein folding, probabilistic machine learning and Bayesian inference, molecular dynamics, whole cell modeling.}
...
\cvlistitem{\textbf{Bayesian inference and Bayesian networks} - Experienced in rapidly prototyping inference problems for parameter selection in pharmacokinetic models, by building directed Bayesian networks describing the input-output correlations. Built customized distributions for PyMC3.}
