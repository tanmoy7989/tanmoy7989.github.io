...
\cvline{Softwares}{MATLAB, Mathematica, Lammps, Gromacs, IMP, VMD, UCSF Chimera/X}
\cvline{ML libraries}{PyTorch, PyMC3}
\cvline{Languages}{Python (\textasciitilde 10000 lines), Fortran-90 (\textasciitilde 1000 lines), C++ (\textasciitilde 2000 lines), Bash, TCL}
...
\subsection*{* authors have equal contribution}
\cvlistitem{F.D. Mast, P.C. Fridy, N.E. Karen, J. Wang, E.Y. Jacobs, J.P. Olivier, T. Sanyal, K.R. Molloy, F. Schmidt, M. Rutkowska, Y. Weisblum, L.M. Rich, E.R. Vanderwall, N. Dambrauskas, V. Vigdorovich, S. Keegan, J.B. Jiler, M.E. Stein, P.D.B Olinares, T. Hatziioannou, D.N. Sather, J.S. Debley, D. Fenyo, A. Sali, P.D. Bieniasz, J.D. Aitchison, B.T. Chait \& M.P. Rout, \textit{Nanobody repertoires for exposing vulnerabilities of SARS-CoV-2}, (2021), preprint: bioRxiv 2021.04.08.438911\\}

\cvlistitem{B. Raveh*, L. Sun*, K.L. White*, T. Sanyal*, J. Tempkin, D. Zheng, K.B. Pilla, J. Singla, C,Wang, J. Zhao, A. Li, N.A. Graham, C. Kesselman, R.C. Stevens \& A. Sali, \textit{Bayesian metamodeling of complex biological systems across varying representations}, (2021) pre-print: bioRxiv 2021.03.29.437574\\}

\cvlistitem{Y. Yu*, S. Li*, Z. Ser*, T. Sanyal*, K. Choi, B. Wan, H.Kuang, A. Sali, A. Kentsis, D.J. Patel \& X. Zhao, \textit{Integrative analysis reveals unique structural and functional features of the Smc5/6 complex}. P. Natl. Acad. Sci. USA. (2021) 118(\textbf{19}), e2026844118\\}
  
\cvlistitem{T. Sanyal, J. Mittal \& M.S. Shell,\textit{ A hybrid, bottom up, structurally-accurate, G$\bar{o}$-like coarse-grained protein model}. J. Chem. Phys. (2019) 151, 044111 (\textit{Editor's pick article, 2019})\\}

\cvlistitem{D. Rosenberger, T. Sanyal, M.S. Shell \& N.F.A. van der Vegt, \textit{Transferability of local density-assisted implicit solvation models for homogeneous fluid mixtures.} J. Chem. Theory Comput. (2019) 15, 2881-2895\\}

\cvlistitem{M.P. Howard, W.F. Reinhart, T. Sanyal, M.S. Shell, A. Nikoubashman \& A.Z. Panagiotopoulos, \textit{Evaporation-induced assembly of colloidal crystals.} J. Chem. Phys. (2018) 149(\textbf{9})\\}

\cvlistitem{T. Sanyal \& M.S. Shell, \textit{Transferable coarse-grained models of liquid-liquid equilibrium using local density potentials optimized with the relative entropy.} J. Phys. Chem. B (2018) 122 (\textbf{21}), 5678-5693\\}

\cvlistitem{T. Sanyal \& M.S. Shell, \textit{Coarse-grained models using local-density potentials optimized with the relative entropy: Application to implicit solvation.} J. Chem. Phys. (2016) \textbf{145}, 034109\\}

\cvlistitem{T. Sanyal \& S. Chakraborty, \textit{Multiscale analysis of hypoxemia in methemoglobin-anemia.} Math. Biosci. (2013) \textbf{241}, 167-180\\}

\cvlistitem{T. Sanyal \& S. Chakraborty, \textit{Multiscale analysis of simultaneous uptake of two interacting gases in the human lungs and its application to methemoglobin anemia.} Comput. Chem. Engg. (2013) \textbf{59}, 226-242}

\section{\textbf{Conference Presentations}}
\cvlistitem{PDB50: A special symposium celebrating the 50th anniversary of the Protein Data Bank; virtual (May. 2021) \textbf{Posters}: \textit{Integrative modeling of the Smc5/6 complex} \& \textit{Playing Bayesian jigsaw with PDB structures: Optimizing rigid body representations for integrative modeling\\}}
