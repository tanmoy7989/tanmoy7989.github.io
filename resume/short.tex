...
\cvlistitem{\textbf{Master's Thesis: Formation and Stability of Mixing-Limited Patterns in Homogeneous Autocatalytic Reactors} \newline Developed bifurcation and linear perturbation theory approaches to determine parameters that give rise to meta-stable transport limited patterns in 2D reactor models of autocatalytic reactions..}
