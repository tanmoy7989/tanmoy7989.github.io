...
The build process has been somewhat automated using the ```build.py``` script.<br>Usage: <code>python build.py -cv cvtype -m commitmsg -r</code><br>where
...
* r : Raise this flag to remove old builds and rebuild from scratch